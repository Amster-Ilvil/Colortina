...
def capture_edit_state(page) -> dict:
    return {
        ...
        "bias_brush_reference_bgr": copy_image(getattr(page, "bias_brush_reference_bgr", None)),
        "bias_brush_reference_filter_bgr": copy_image(getattr(page, "bias_brush_reference_filter_bgr", None)),
...
def snapshots_equal(left: dict, right: dict) -> bool:
    return (image_equal(left.get("result_bgr"), right.get("result_bgr")) and
            ...
            image_equal(left.get("bias_brush_reference_bgr"), right.get("bias_brush_reference_bgr")) and
            image_equal(left.get("bias_brush_reference_filter_bgr"), right.get("bias_brush_reference_filter_bgr")) and
...
def restore_edit_state(page, snapshot: dict) -> None:
    ...
    page.bias_brush_reference_bgr = copy_image(snapshot.get("bias_brush_reference_bgr"))
    page.bias_brush_reference_filter_bgr = copy_image(snapshot.get("bias_brush_reference_filter_bgr"))
