...
## Colortina v5.13.27 更新（2026-08-10）

> 本节为新增内容；上方原 README 全部保留，不做删减。
...
- **源码与隐私**：公开仓库不应包含用户图片、项目文件、导出结果、模型权重、缓存、凭据、令牌、私钥或真实用户主目录路径；发布流程继续执行隐私审计。
- **版本**：当前发布核心版本为 **v5.13.27**；现有 GitHub Actions 发布流程覆盖 Windows x64、macOS Apple Silicon、macOS Intel 与 Linux x64，并生成 SHA-256 校验文件。
